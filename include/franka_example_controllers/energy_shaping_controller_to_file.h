...
class EnergyShapingControllerToFile : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  ros::Publisher H0_pub;
  ros::Publisher H1_pub;
  ros::Publisher H2_pub;
  ros::Publisher H3_pub;
  ros::Publisher H4_pub;
  ros::Publisher H5_pub;
  ros::Publisher H6_pub;
